@echo off
REM ============================================================================
REM Docker Full Cleanup and VHDX Compaction Script
REM ============================================================================
REM This script must be run as Administrator
REM It will remove all containers and images, prune Docker, and compact the VHDX
REM ============================================================================


echo.
echo ============================================================================
echo Docker Full Cleanup and VHDX Compaction
echo ============================================================================
echo.
...
set /p CONFIRM="WARNING: This will DELETE ALL Docker containers and images! Type I AM SURE to continue: "
if /I NOT "%CONFIRM%"=="I AM SURE" (
    echo.
...
if %errorLevel% neq 0 (
    echo Warning: No running containers to stop or remove
)
...
if %errorLevel% neq 0 (
    echo Warning: No images to remove
)

echo.
echo Step 3: Pruning Docker system (volumes, cache)...
...
echo.
echo Step 4: Stopping Docker Desktop processes...
...
echo.
echo Step 6: Checking VHDX file size BEFORE compaction...
...
echo.
echo Step 7: Compacting Docker VHDX file...
...
echo.
echo Step 8: Checking VHDX file size AFTER compaction...
powershell -Command "Get-ChildItem -Path \"$env:LOCALAPPDATA\Docker\wsl\disk\" -Filter '*.vhdx' | Select-Object Name, @{Name='Size(GB)';Expression={[math]::Round($_.Length/1GB,2)}}"
