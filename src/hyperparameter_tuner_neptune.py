...
def chunk_size_optimization_with_neptune(
    ...
    tuner.start_neptune_run(
        ...
        description="Grid search over chunk sizes and overlaps for embedding generation"
    )
    
    try:
        param_grid = {
            'CHUNK_STRATEGY': ['fixed_size'],
            'FIXED_SIZE_CHUNK_SIZE': [750, 1000, 1250, 1500, 2000, 3000, 4000],
            'FIXED_SIZE_OVERLAP': [150, 250, 350, 450],
