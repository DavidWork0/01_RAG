...
"""
In this current version, inference.load_model() must be called before inference.run_model() to initialize the model.!!!
"""
...
# Define a function to run the model system message and user message can be passed as arguments and defaults are provided
def run_model(llm, system_message="You are a helpful assistant.", user_message="What is speed of light?"):
...
if __name__ == "__main__":
    ...
    response = run_model(llm, user_message="What is speed of a jet?")
    print(response)